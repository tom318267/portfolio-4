...
const About = () => {
  return (
    <div
      id="about"
      className="bg-black text-white text-center sm:text-left font-alata p-20"
    >
      <div>
        <h1 className="text-3xl mb-8">About Me</h1>
        <p className="mb-8 text-lg">
          My name is Tom Rago. I am a self-taught web developer. I started
          learning about three years ago. I was stuck in a dead-end job and was
          not very happy with where my career was going. I searched and searched
